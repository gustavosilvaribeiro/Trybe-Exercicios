...
let player = {      // Crie a variável player, inicialmente armazenando um objeto vazio.
    //Adicione as variáveis como chaves do objeto player, com seus respectivos valores.
    name : "Marta",
    lastName : 'Silva',
    age : 34,
...
console.log(`A jogadora ${player.name} ${player.lastName} foi possui 2 medalhas de ouro e 3 medalhas de prata.`);
